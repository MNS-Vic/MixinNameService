 ...
 *       - Canonical form of names is not checked; in MNS this is done on the frontend, so submitting
 *         proofs with non-canonical names will only result in registering unresolvable MNS names.
 */
