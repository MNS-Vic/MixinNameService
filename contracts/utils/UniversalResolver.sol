 ...
 * making it possible to make a single smart contract call to resolve an MNS name.
 */
contract UniversalResolver is ERC165, Ownable {
    ...
    MNS public immutable registry;

    constructor(address _registry, string[] memory _urls) {
        registry = MNS(_registry);
    ...
    /**
     * @dev Performs MNS name resolution for the supplied name and resolution data.
     * @param name The name to resolve, in normalised and DNS-encoded form.
     * @param data The resolution data, as specified in MNSIP-10.
    ...
    /**
     * @dev Performs MNS name reverse resolution for the supplied reverse name.
